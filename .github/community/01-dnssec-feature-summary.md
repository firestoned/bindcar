...
> **Status:** 📄 Reference — a record of shipped work, not a phase with a
> completion state. DNSSEC support is in the tree: `dnssecPolicy` / `inlineSigning`
> on `zones::ZoneConfig` and the `auto_dnssec` / `key_directory` /
> `sig_validity_interval` family on `rndc_types::ZoneConfig`.
>
...
**Date**: 2025-02-06
**Branch**: `dnssec`
**Original status (as written)**: ✅ Complete - Ready for Review
...
**Location**: [docs/src/advanced/dnssec.md](../../docs/src/advanced/dnssec.md)
...
**Location**: [docs/src/user-guide/zone-config.md](../../docs/src/user-guide/zone-config.md)
...
**Location**: [docs/src/reference/api-zones.md](../../docs/src/reference/api-zones.md)
...
**Location**: docs/src/SUMMARY.md (mdbook `SUMMARY.md`, since replaced by mkdocs `nav`)
...
- [DNSSEC Guide](../../docs/src/advanced/dnssec.md) - Comprehensive DNSSEC documentation
- [Zone Configuration](../../docs/src/user-guide/zone-config.md) - Zone config reference
- [API Reference](../../docs/src/reference/api-zones.md) - REST API documentation
