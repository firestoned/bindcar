...
| [`docs/src/developer-guide/k8s-token-validation.md`](../../docs/src/developer-guide/k8s-token-validation.md) | Existing TokenReview documentation — update in Phase 5 |
| [`docs/src/operations/env-vars.md`](../../docs/src/operations/env-vars.md) | Env var reference — update in Phase 5 |
